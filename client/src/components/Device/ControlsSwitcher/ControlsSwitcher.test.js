...
import ControlsSwitcher from "./ControlsSwitcher.jsx";
import {
  TEMPERATURE,
  MODE,
  SCALE
} from "./../../../utils/deviceControls.types";
import TemperatureControl from "../Controls/Temperature/TemperatureControl.jsx";
import ModeControl from "../Controls/Mode/ModeControl.jsx";
import ScaleControl from "../Controls/Scale/ScaleControl.jsx";
